...
public class DUEPayment extends JFrame implements ActionListener{

    String cname,cid,cemail,ccontact,cpass;
    JTextField ClientId;
    JButton search,back;
    JTable table;
    DUEPayment(String cname,String cid,String cemail,String ccontact,String cpass){
     ...
     public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==search){
            ...
            String query="select * from transition where client_id='"+ClientId.getText()+"'";
            try{
