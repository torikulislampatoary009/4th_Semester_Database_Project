...
import javax.swing.*;
public class UpdateFacultyPass extends JFrame implements ActionListener{
        ...
        if(ae.getSource()==Add){
          /* StudentTamplate s= new StudentTamplate(studentName.getText(),studentID.getText(),studentB.getText(),studentD.getText(),iMN.getText(),iFN.getText(),Dob.getText(),mobile.getText(),Password.getText());
           ...
           try {
            ...
            String query="update faculty set pass='"+password.getText()+"' where id='"+facultyID.getText()+"'";
